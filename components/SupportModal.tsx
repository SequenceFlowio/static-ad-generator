...
export default function SupportModal({ onClose }: { onClose: () => void }) {
  ...
  function copyEmail() {
    navigator.clipboard.writeText("hello@sequenceflow.io");
    setCopied(true);
      ...
      <div className="w-full max-w-sm rounded-2xl bg-white dark:bg-gray-900 shadow-2xl overflow-hidden">
        ...
        <div className="flex items-center justify-between px-5 py-4 border-b border-gray-100 dark:border-gray-800">
          <div>
            ...
            <p className="text-xs text-gray-400 dark:text-gray-500 mt-0.5">Have questions or need help? Reach out to our support team.</p>
          </div>
        ...
        <div className="p-4 space-y-2">
          ...
          >
            ...
            <div className="flex-1">
              ...
              <p className="text-xs text-gray-400 dark:text-gray-500">Browse guides, tutorials, and FAQs</p>
            </div>
          ...
          <div className="flex items-center gap-3 rounded-xl bg-gray-50 dark:bg-gray-800 p-4">
            ...
            <p className="flex-1 text-sm font-semibold text-gray-900 dark:text-white">hello@sequenceflow.io</p>
            <button
              onClick={copyEmail}
        ...
        <div className="px-4 pb-4">
          <a
            href="mailto:hello@sequenceflow.io"
