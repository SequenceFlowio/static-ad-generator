...
const SUPPORT_CARDS = [
  {
    ...
    title: "Support",
    description: "Have a question or running into an issue? Our team is here to help.",
    cta: "Contact support",
  ...
  },
  {
    ...
    description: "Need a specific section for your store? Tell us and we'll build it.",
    cta: "Request section",
  ...
  },
  {
    ...
    description: "Have an idea that would make SequenceFlow better? We'd love to hear it.",
    cta: "Request feature",
  ...
  },
  {
    ...
    description: "Join our affiliate program and earn commission on every referral.",
      ...
      <section className="mb-12 border-t border-gray-200 dark:border-gray-800 pt-10">
        <div className="grid grid-cols-2 gap-4 lg:grid-cols-4">
          {SUPPORT_CARDS.map((card) => (
            <div key={card.title} className="flex flex-col gap-3 rounded-xl border border-gray-200 dark:border-gray-800 p-5">
              <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-gray-100 dark:bg-gray-800">
                {card.icon}
              </div>
              <div>
                <p className="text-sm font-semibold text-gray-900 dark:text-white">{card.title}</p>
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400 leading-relaxed">{card.description}</p>
              </div>
              {card.action === "support" ? (
                <button
